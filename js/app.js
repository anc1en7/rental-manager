...
;(function () {
  ...
  var translations = {
    en: {
      ...
      send_reset_link:'Send Reset Link', reset_sent:'Check your email for the reset link.',
      settings:'Settings',
      ...
      view_room:'View Room', duplicate:'Duplicate',
      ...
      share_property:'Share Room',
      share_public:'Public', share_private:'Private',
      share_public_desc:'Anyone with the link can view this property.',
      share_private_desc:'Only people with the correct password can view this property.',
      share_access_password:'Access Password',
      share_password_placeholder:'Set a password for visitors',
      share_show_rent:'Show Rent Prices',
      share_link_expiry:'Link Expiry',
      share_expiry_never:'Never expires',
      share_expiry_7d:'7 days', share_expiry_30d:'30 days', share_expiry_90d:'90 days',
      share_generate:'Generate Link', share_copy:'Copy Link', share_copied:'Copied!',
      share_active_links:'Active Links',
      share_no_links:'No active share links yet.',
      share_revoke:'Revoke',
      share_revoke_confirm:'Revoke this link? Anyone with the link will no longer be able to view the property.',
      share_revoked:'Link revoked.',
      share_views:'views', share_expires:'Expires', share_never_expires:'No expiry',
      share_link_generated:'Link generated!',
      share_pw_required:'Please enter a password.',
      share_generating:'Generating…',
      share_invalid_title:'Link Not Found',
      share_invalid_msg:'This share link is invalid or has been revoked.',
      share_expired_title:'Link Expired',
      share_expired_msg:'This share link has expired.',
      share_pw_gate_title:'Password Protected',
      share_pw_gate_subtitle:'Enter the password to view this property.',
      share_pw_wrong:'Incorrect password. Please try again.',
      share_unlock:'Unlock',
      share_listing:'Property Listing',
    },
    de: {
      ...
      forgot_subtitle:'Gib deine E-Mail ein und wir senden dir einen Link.',
      send_reset_link:'Reset-Link senden', reset_sent:'Prüfe deine E-Mails für den Reset-Link.',
      ...
      view_room:'Zimmer ansehen', duplicate:'Duplizieren',
      ...
      share_property:'Zimmer teilen',
      share_public:'Öffentlich', share_private:'Privat',
      share_public_desc:'Jeder mit dem Link kann diese Immobilie ansehen.',
      share_private_desc:'Nur Personen mit dem richtigen Passwort können diese Immobilie ansehen.',
      share_access_password:'Zugriffspasswort',
      share_password_placeholder:'Passwort für Besucher festlegen',
      share_show_rent:'Mietpreise anzeigen',
      share_link_expiry:'Link-Ablauf',
      share_expiry_never:'Läuft nie ab',
      share_expiry_7d:'7 Tage', share_expiry_30d:'30 Tage', share_expiry_90d:'90 Tage',
      share_generate:'Link generieren', share_copy:'Link kopieren', share_copied:'Kopiert!',
      share_active_links:'Aktive Links',
      share_no_links:'Noch keine aktiven Freigabe-Links.',
      share_revoke:'Widerrufen',
      share_revoke_confirm:'Diesen Link widerrufen? Niemand kann die Immobilie mehr darüber aufrufen.',
      share_revoked:'Link widerrufen.',
      share_views:'Aufrufe', share_expires:'Läuft ab', share_never_expires:'Kein Ablauf',
      share_link_generated:'Link generiert!',
      share_pw_required:'Bitte gib ein Passwort ein.',
      share_generating:'Wird erstellt…',
      share_invalid_title:'Link nicht gefunden',
      share_invalid_msg:'Dieser Link ist ungültig oder wurde widerrufen.',
      share_expired_title:'Link abgelaufen',
      share_expired_msg:'Dieser Freigabe-Link ist abgelaufen.',
      share_pw_gate_title:'Passwortgeschützt',
      share_pw_gate_subtitle:'Gib das Passwort ein, um diese Immobilie anzusehen.',
      share_pw_wrong:'Falsches Passwort. Bitte erneut versuchen.',
      share_unlock:'Entsperren',
      share_listing:'Immobilieninserat',
    }
  }
